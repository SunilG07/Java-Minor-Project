				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="about.html">About</a></li>
				           <li><a href="about.html">Kathmandu</a></li>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="resources/img/d1.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="resources/img/d2.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="resources/img/d3.jpg" alt="">
								</div>
								<div class="desc">	
